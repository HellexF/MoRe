...
def get_args_parser():
    ...
    parser.add_argument("--config_name", type=str, default="full_attn_test.yaml", help="config file name") # token_copy_test.yaml
    parser.add_argument(
        "--output_dir",
        type=str,
        default="",
    ...
    with distributed_state.split_between_processes(seq_list) as seqs:
        ...
        for seq in tqdm(seqs):
            try:
                ...
                depth_conf = depth_conf.squeeze().cpu()
                ...
                save_depth_maps(depth_map, f"{save_dir}/{seq}", conf_self=depth_conf)
...
if __name__ == "__main__":
    ...
    with initialize(version_base=None, config_path=config_path):
        cfg = compose(config_name="full_attn_test")
