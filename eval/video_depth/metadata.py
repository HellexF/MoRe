...
dataset_metadata = {
    ...
    "kitti": {
        "img_path": "/lpai/dataset/action-model-group-data-weight/0-1-0/datasets/cut3r_data/eval_data/kitti/depth_selection/val_selection_cropped/image_gathered",  # Default path
        "mask_path": None,
        "dir_path_func": lambda img_path, seq: os.path.join(img_path, seq),
        "gt_traj_func": lambda img_path, anno_path, seq: None,
        "traj_format": None,
    ...
    "bonn": {
        "img_path": "/lpai/volumes/base-3da-ali-sh-mix/zhangwq/dataset/vggt/rgbd_bonn_dataset",
        "mask_path": None,
    ...
    "tum": {
        "img_path": "/lpai/volumes/base-3da-ali-sh-mix/zhangwq/dataset/vggt/TUM",
        "mask_path": None,
    ...
    "sintel": {
        "img_path": "/lpai/volumes/base-3da-ali-sh-mix/zhangwq/dataset/vggt/MPI-Sintel-training_images/training/final",
        "anno_path": "/lpai/volumes/base-3da-ali-sh-mix/zhangwq/dataset/vggt/MPI-Sintel-depth-training-20150305/training/camdata_left",
        "mask_path": None,
        "dir_path_func": lambda img_path, seq: os.path.join(img_path, seq),
