...
class TUMDynamicsDataset(BaseDataset):
    def __init__(
        self,
        TUM_DYNAMICS_DIR: str = None,
        type_: str = "video",
    ):

        logging.info(f"TUM_DYNAMICS_DIR is {TUM_DYNAMICS_DIR}")

        self.TUM_DYNAMICS_DIR = TUM_DYNAMICS_DIR
        # self.img_size = 518
        # self.patch_size = 14
        self.training = False
        ...
        self.sequence_list = os.listdir(self.TUM_DYNAMICS_DIR)
